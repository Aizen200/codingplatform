    ...
    },
    {
      ...
      ,
      {
        ...
        testcase: [
          ...
          { input: { nums:[1], k:10 }, expectedOutput: [1] }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { nums:[10,5,2,7,1,9], k:15 }, expectedOutput: 4 },
          { input: { nums:[1,2,3,7,5], k:12 }, expectedOutput: 3 }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { nums:[3,2,2,3], target:3 }, expectedOutput: [2,2] },
          { input: { nums:[1,2,3,4,5], target:6 }, expectedOutput: [1,2,3,4,5] }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          ...
          { input: { nums:[1,3,4,6,8,11], target:10 }, expectedOutput: [1,3] }
        ]
      },
      {
        title: "Remove Duplicates from Sorted Array",
      ...
      },
      {
        ...
        testcase: [
          { input: { arr1:[1,3,5], arr2:[2,4,6] }, expectedOutput: [1,2,3,4,5,6] },
          { input: { arr1:[], arr2:[1,2,3] }, expectedOutput: [1,2,3] }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { nums:[2,3,1,2,4,3], target:7 }, expectedOutput: 2 },
          { input: { nums:[1,4,4], target:4 }, expectedOutput: 1 }
      ...
      },
      {
        ...
        testcase: [
          { input: { nums:[1,3,5,8,10], k:2 }, expectedOutput: true },
          { input: { nums:[1,3,5], k:4 }, expectedOutput: false }
        ]
      },
      {
        ...
        testcase: [
          { input: { nums:[1,2,3,4,5], target:6 }, expectedOutput: 4 },
          { input: { nums:[1,1,2,2,3], target:4 }, expectedOutput: 4 }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { nums:[1,3,5,7], target:5 }, expectedOutput: 2 },
          { input: { nums:[1,3,5,7], target:6 }, expectedOutput: -1 }
        ]
      },
      {
        ...
        testcase: [
          { input: { nums:[1,2,2,2,3], target:2 }, expectedOutput: 1 },
          { input: { nums:[5,5,5,6,7], target:5 }, expectedOutput: 0 }
        ]
      },
      {
        ...
        testcase: [
          ...
          { input: { nums:[4,5,6,6,6,7], target:6 }, expectedOutput: 4 }
        ]
      },
      {
        ...
        testcase: [
          { input: { nums:[1,2,2,2,3], target:2 }, expectedOutput: 3 },
          { input: { nums:[4,4,4,4,5,6], target:4 }, expectedOutput: 4 }
        ]
      },
      {
        ...
        testcase: [
          { input: { nums:[1,2,4,6,8], target:5 }, expectedOutput: 4 }
        ]
      },
      {
        ...
        testcase: [
          ...
          { input: { nums:[2,3,5,7,9], target:1 }, expectedOutput: -1 }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { nums:[2,3,4,7,11], k:5 }, expectedOutput: 9 },
          { input: { nums:[1,2,3,4], k:2 }, expectedOutput: 6 }
        ]
      },
      {
        ...
        testcase: [
          { input: { books:[12,34,67,90], students:2 }, expectedOutput: 113 },
          { input: { books:[10,20,30,40], students:2 }, expectedOutput: 60 }
        ]
      },
      {
        ...
        testcase: [
          ...
          { input: { stalls:[1,3,5,7,9], cows:3 }, expectedOutput: 4 }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { bloomDay:[1,10,3,10,2], m:3, k:1 }, expectedOutput: 3 },
          { input: { bloomDay:[7,7,7,7,12,7,7], m:2, k:3 }, expectedOutput: 12 }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { x:2, n:5 }, expectedOutput: 32 },
          { input: { x:3, n:3 }, expectedOutput: 27 }
        ]
      },
      {
      ...
      },
      {
        ...
        testcase: [
          { input: { n:7, k:3 }, expectedOutput: 4 },
          { input: { n:5, k:2 }, expectedOutput: 3 }
        ]
      },
      {
        title: "Subset Sum",
        ...
        testcase: [
          { input: { nums:[3,34,4,12,5,2], target:9 }, expectedOutput: true },
      ...
      },
      {
        ...
        testcase: [
          { input: { wt:[1,3,4,5], val:[1,4,5,7], W:7 }, expectedOutput: 9 },
          { input: { wt:[2,3,4], val:[4,5,6], W:5 }, expectedOutput: 6 }
        ]
      },
      {
        title: "Edit Distance",
